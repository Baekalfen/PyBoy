...
class Tile:
    def __init__(self, mb, identifier):
        ...
        `pyboy.PyBoy.get_tile`, `pyboy.botsupport.sprite.Sprite` and `pyboy.botsupport.tilemap.TileMap`, when
    ...
    tile_identifier = property(_get_identifier)
    ...
    data_address = property(_get_data_address)
