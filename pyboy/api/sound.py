...
class Sound:
    ...
    def __init__(self, mb):
        ...
        400
        >>> (400+1) * 2 # Minimum buffer size for you to prepare (2 channels, +1 for fluctuating lengths)
        802
        >>> 802 == pyboy.sound.raw_buffer_length # This is how the length is calculated at the moment
        True
        ```
