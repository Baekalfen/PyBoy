...
from pyboy.plugins.game_wrapper_bomberman_gb cimport GameWrapperBombermanGB
# imports end
...
cdef class PluginManager:
    ...
    cdef public GameWrapperBombermanGB game_wrapper_bomberman_gb
    ...
    cdef bint game_wrapper_bomberman_gb_enabled
    # plugin_cdef end
