...
setup(
    ...
    ext_modules=cythonize([
        ...
        'pyboy/motherboard/cpu.py',
        'pyboy/motherboard/opcodes.py',
        'pyboy/motherboard/timer.py',
        'pyboy/motherboard/motherboard.py',
        'pyboy/motherboard/__init__.py',
        'pyboy/__init__.py',
        'pyboy/pyboy.py',
        ...
        include_path=[".", "pyboy", "pyboy/cartridge", "pyboy/mb",
                      "pyboy/window"],
