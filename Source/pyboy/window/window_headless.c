...
{
    "distutils": {
        "name": "pyboy.window.window_headless",
        "sources": [
            "pyboy/window/window_headless.py"
        ]
    },
    "module_name": "pyboy.window.window_headless"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyboy__window__window_headless
#define __PYX_HAVE_API__pyboy__window__window_headless
/* Early includes */
#include <stdint.h>
#include <string.h>
#include <stdio.h>
...
struct __pyx_obj_5pyboy_6window_12debug_window_Window;
struct __pyx_obj_5pyboy_6window_12debug_window_TileWindow;
struct __pyx_obj_5pyboy_6window_12debug_window_TileViewWindow;
struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow;
struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow;
struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow;
...
/* "pyboy/window/window_headless.pxd":15
 * 
 * 
...
/* "pyboy/window/window_headless.pxd":16
 * 
 * cdef (int, int) _dummy_declaration
 * cdef (int, int, int, int) _dummy_declaration2             # <<<<<<<<<<<<<<
 * 
...
/* "pyboy/window/debug_window.pxd":26
...
struct __pyx_obj_5pyboy_6window_12debug_window_Window {
  PyObject_HEAD
  struct __pyx_vtabstruct_5pyboy_6window_12debug_window_Window *__pyx_vtab;
  struct __pyx_obj_5pyboy_3lcd_LCD *lcd;
  int width;
  int height;
  int scale;
  SDL_Window *window;
  arrayobject *buf;
  __Pyx_memviewslice buf0;
  PyObject *buf_p;
  SDL_Renderer *sdlrenderer;
  SDL_Texture *sdl_texture_buffer;
  int mouse_x;
  int mouse_y;
  int mouse_hover_x;
  int mouse_hover_y;
...
/* "pyboy/window/debug_window.pxd":63
 * 
 * 
 ...
 */
struct __pyx_obj_5pyboy_6window_12debug_window_TileWindow {
  struct __pyx_obj_5pyboy_6window_12debug_window_Window __pyx_base;
};


/* "pyboy/window/debug_window.pxd":70
 * 
 * 
...
/* "pyboy/window/debug_window.pxd":77
 * 
 * 
...
struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow {
  PyObject_HEAD
  struct __pyx_vtabstruct_5pyboy_6window_12debug_window_DebugWindow *__pyx_vtab;
  struct __pyx_obj_5pyboy_3lcd_LCD *lcd;
  uint32_t color_palette[4];
  unsigned int scale;
  int marked_tile;
  struct __pyx_obj_5pyboy_6window_12debug_window_TileViewWindow *tile1;
  struct __pyx_obj_5pyboy_6window_12debug_window_TileViewWindow *tile2;
  struct __pyx_obj_5pyboy_6window_12debug_window_Window *sprite;
  struct __pyx_obj_5pyboy_6window_12debug_window_TileWindow *tile;
  int tile_data_width;
  int tile_data_height;
  arrayobject *tile_cache;
  __Pyx_memviewslice tile_cache0;
  PyObject *tile_cache_p;
  uint8_t scanline_parameters[0x90][4];
  SDL_Window *_window;
  SDL_Renderer *_sdlrenderer;
  SDL_Texture *_sdl_texture_buffer;
  int clear_cache;
  PyObject *tiles_changed;
};
...
struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow {
  ...
  uint8_t _scanlineparameters[0x90][4];
  SDL_Window *_window;
  SDL_Renderer *_sdlrenderer;
  SDL_Texture *_sdltexturebuffer;
  int debug;
  struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow *debugger;
};


/* "pyboy/window/window_headless.pxd":20
 * cdef int ROWS, COLS
 * 
 ...
 */
struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow {
  struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow __pyx_base;
  struct __pyx_obj_5pyboy_3lcd_LCD *lcd;
};
...
struct __pyx_vtabstruct_5pyboy_6window_12debug_window_Window {
  void (*reset_hover)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *);
  void (*stop)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *);
  void (*copy_tile)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *, __Pyx_memviewslice, int, __pyx_ctuple_int__and_int, __Pyx_memviewslice);
  void (*update_display)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *);
  void (*_update_display)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *);
  int (*mouse)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *, int, int, int, int);
  int (*_mouse)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *, int, int, int, int);
  void (*mark_tile)(struct __pyx_obj_5pyboy_6window_12debug_window_Window *, int, int, int);
};
static struct __pyx_vtabstruct_5pyboy_6window_12debug_window_Window *__pyx_vtabptr_5pyboy_6window_12debug_window_Window;
static CYTHON_INLINE void __pyx_f_5pyboy_6window_12debug_window_6Window__update_display(struct __pyx_obj_5pyboy_6window_12debug_window_Window *);
...
struct __pyx_vtabstruct_5pyboy_6window_12debug_window_TileWindow {
  struct __pyx_vtabstruct_5pyboy_6window_12debug_window_Window __pyx_base;
  void (*update)(struct __pyx_obj_5pyboy_6window_12debug_window_TileWindow *, __Pyx_memviewslice);
  void (*draw_overlay)(struct __pyx_obj_5pyboy_6window_12debug_window_TileWindow *, int, uint8_t (*)[4]);
};
static struct __pyx_vtabstruct_5pyboy_6window_12debug_window_TileWindow *__pyx_vtabptr_5pyboy_6window_12debug_window_TileWindow;
...
struct __pyx_vtabstruct_5pyboy_6window_12debug_window_TileViewWindow {
  struct __pyx_vtabstruct_5pyboy_6window_12debug_window_Window __pyx_base;
  void (*update)(struct __pyx_obj_5pyboy_6window_12debug_window_TileViewWindow *, struct __pyx_obj_5pyboy_3lcd_LCD *, __Pyx_memviewslice);
  void (*draw_overlay)(struct __pyx_obj_5pyboy_6window_12debug_window_TileViewWindow *, int, uint8_t (*)[4], int, int);
};
static struct __pyx_vtabstruct_5pyboy_6window_12debug_window_TileViewWindow *__pyx_vtabptr_5pyboy_6window_12debug_window_TileViewWindow;
...
struct __pyx_vtabstruct_5pyboy_6window_12debug_window_DebugWindow {
  void (*set_lcd)(struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow *, struct __pyx_obj_5pyboy_3lcd_LCD *);
  void (*mouse)(struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow *, int, int, long, long);
  void (*scanline)(struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow *, int);
  void (*update)(struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow *);
  void (*update_cache)(struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow *);
};
static struct __pyx_vtabstruct_5pyboy_6window_12debug_window_DebugWindow *__pyx_vtabptr_5pyboy_6window_12debug_window_DebugWindow;
...
struct __pyx_vtabstruct_5pyboy_6window_11window_sdl2_SDLWindow {
  struct __pyx_vtabstruct_5pyboy_6window_11base_window_BaseWindow __pyx_base;
  void (*_update_display)(struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow *);
};
static struct __pyx_vtabstruct_5pyboy_6window_11window_sdl2_SDLWindow *__pyx_vtabptr_5pyboy_6window_11window_sdl2_SDLWindow;
static CYTHON_INLINE void __pyx_f_5pyboy_6window_11window_sdl2_9SDLWindow__update_display(struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow *);


/* "pyboy/window/window_headless.py":13
 * 
 * 
...
struct __pyx_vtabstruct_5pyboy_6window_15window_headless_HeadlessWindow {
  struct __pyx_vtabstruct_5pyboy_6window_11window_sdl2_SDLWindow __pyx_base;
};
static struct __pyx_vtabstruct_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_vtabptr_5pyboy_6window_15window_headless_HeadlessWindow;
...
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_init(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self); /* proto*/
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_set_title(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, PyObject *__pyx_v_title); /* proto*/
static PyObject *__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_get_events(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self); /* proto*/
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_update_display(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self); /* proto*/
static PyObject *__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_getscreenbuffer(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self); /* proto*/
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_frame_limiter(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, CYTHON_UNUSED int __pyx_v_speed); /* proto*/
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_stop(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self); /* proto*/
static CYTHON_INLINE void __pyx_f_5pyboy_6window_12debug_window_6Window__update_display(struct __pyx_obj_5pyboy_6window_12debug_window_Window *__pyx_v_self); /* proto*/
static CYTHON_INLINE void __pyx_f_5pyboy_6window_11window_sdl2_9SDLWindow__update_display(struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow *__pyx_v_self); /* proto*/
...
/* Module declarations from 'pyboy.window.debug_window' */
static PyTypeObject *__pyx_ptype_5pyboy_6window_12debug_window_Window = 0;
static PyTypeObject *__pyx_ptype_5pyboy_6window_12debug_window_TileWindow = 0;
static PyTypeObject *__pyx_ptype_5pyboy_6window_12debug_window_TileViewWindow = 0;
static PyTypeObject *__pyx_ptype_5pyboy_6window_12debug_window_DebugWindow = 0;
static __pyx_ctuple_int__and_int__and_int__and_int *__pyx_vp_5pyboy_6window_12debug_window__dummy_declaration2 = 0;
#define __pyx_v_5pyboy_6window_12debug_window__dummy_declaration2 (*__pyx_vp_5pyboy_6window_12debug_window__dummy_declaration2)
static int *__pyx_vp_5pyboy_6window_12debug_window_TILES = 0;
#define __pyx_v_5pyboy_6window_12debug_window_TILES (*__pyx_vp_5pyboy_6window_12debug_window_TILES)
static int *__pyx_vp_5pyboy_6window_12debug_window_COLOR = 0;
#define __pyx_v_5pyboy_6window_12debug_window_COLOR (*__pyx_vp_5pyboy_6window_12debug_window_COLOR)
static int *__pyx_vp_5pyboy_6window_12debug_window_MASK = 0;
#define __pyx_v_5pyboy_6window_12debug_window_MASK (*__pyx_vp_5pyboy_6window_12debug_window_MASK)
static __pyx_ctuple_int__and_int *__pyx_vp_5pyboy_6window_12debug_window_GAMEBOY_RESOLUTION = 0;
#define __pyx_v_5pyboy_6window_12debug_window_GAMEBOY_RESOLUTION (*__pyx_vp_5pyboy_6window_12debug_window_GAMEBOY_RESOLUTION)

/* Module declarations from 'pyboy.window.window_sdl2' */
static PyTypeObject *__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow = 0;
static __pyx_ctuple_int__and_int *__pyx_vp_5pyboy_6window_11window_sdl2__dummy_declaration = 0;
#define __pyx_v_5pyboy_6window_11window_sdl2__dummy_declaration (*__pyx_vp_5pyboy_6window_11window_sdl2__dummy_declaration)
static __pyx_ctuple_int__and_int__and_int__and_int *__pyx_vp_5pyboy_6window_11window_sdl2__dummy_declaration2 = 0;
#define __pyx_v_5pyboy_6window_11window_sdl2__dummy_declaration2 (*__pyx_vp_5pyboy_6window_11window_sdl2__dummy_declaration2)
static int *__pyx_vp_5pyboy_6window_11window_sdl2_ROWS = 0;
#define __pyx_v_5pyboy_6window_11window_sdl2_ROWS (*__pyx_vp_5pyboy_6window_11window_sdl2_ROWS)
static int *__pyx_vp_5pyboy_6window_11window_sdl2_COLS = 0;
#define __pyx_v_5pyboy_6window_11window_sdl2_COLS (*__pyx_vp_5pyboy_6window_11window_sdl2_COLS)

/* Module declarations from 'pyboy.window.window_headless' */
static PyTypeObject *__pyx_ptype_5pyboy_6window_15window_headless_HeadlessWindow = 0;
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static __pyx_ctuple_int__and_int __pyx_v_5pyboy_6window_15window_headless__dummy_declaration;
static __pyx_ctuple_int__and_int__and_int__and_int __pyx_v_5pyboy_6window_15window_headless__dummy_declaration2;
static int __pyx_v_5pyboy_6window_15window_headless_ROWS;
static int __pyx_v_5pyboy_6window_15window_headless_COLS;
...
#define __Pyx_MODULE_NAME "pyboy.window.window_headless"
extern int __pyx_module_is_main_pyboy__window__window_headless;
int __pyx_module_is_main_pyboy__window__window_headless = 0;

/* Implementation of 'pyboy.window.window_headless' */
...
static const char __pyx_k_SDLWindow[] = "SDLWindow";
...
static const char __pyx_k_HeadlessWindow[] = "HeadlessWindow";
...
static const char __pyx_k_HeadlessWindow_set_title_s[] = "HeadlessWindow set title: %s";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_pyboy_window_window_headless[] = "pyboy.window.window_headless";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_HeadlessWindow___reduce_cython[] = "HeadlessWindow.__reduce_cython__";
...
static const char __pyx_k_HeadlessWindow___setstate_cython[] = "HeadlessWindow.__setstate_cython__";
...
static const char __pyx_k_self__sdlrenderer_self__sdltextu[] = "self._sdlrenderer,self._sdltexturebuffer,self._window cannot be converted to a Python object for pickling";
...
static PyObject *__pyx_n_s_HeadlessWindow;
static PyObject *__pyx_n_s_HeadlessWindow___reduce_cython;
static PyObject *__pyx_n_s_HeadlessWindow___setstate_cython;
static PyObject *__pyx_kp_s_HeadlessWindow_set_title_s;
...
static PyObject *__pyx_n_s_SDLWindow;
...
static PyObject *__pyx_n_s_pyboy_window_window_headless;
...
static PyObject *__pyx_kp_s_self__sdlrenderer_self__sdltextu;
...
static int __pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow___init__(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, PyObject *__pyx_v_scale, PyObject *__pyx_v_debug); /* proto */
static PyObject *__pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow_2__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow_4__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
...
static PyObject *__pyx_tp_new_5pyboy_6window_15window_headless_HeadlessWindow(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* "pyboy/window/window_headless.py":14
 * 
 * class HeadlessWindow(SDLWindow):
 *     def __init__(self, scale=1, debug=False):             # <<<<<<<<<<<<<<
 *         super(self.__class__, self).__init__(scale, debug)
...
/* Python wrapper */
static int __pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_scale,&__pyx_n_s_debug,0};
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyboy.window.window_headless.HeadlessWindow.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow___init__(((struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *)__pyx_v_self), __pyx_v_scale, __pyx_v_debug);
...
static int __pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow___init__(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, PyObject *__pyx_v_scale, PyObject *__pyx_v_debug) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "pyboy/window/window_headless.py":15
 * class HeadlessWindow(SDLWindow):
 *     def __init__(self, scale=1, debug=False):
 *         super(self.__class__, self).__init__(scale, debug)             # <<<<<<<<<<<<<<
 *         self.lcd = None
 ...
 */
  ...
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[3] = {__pyx_t_2, __pyx_v_scale, __pyx_v_debug};
  ...
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_4, __pyx_v_debug);
  ...
  /* "pyboy/window/window_headless.py":16
 *     def __init__(self, scale=1, debug=False):
 *         super(self.__class__, self).__init__(scale, debug)
 *         self.lcd = None             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_v_self->lcd);
  __Pyx_DECREF(((PyObject *)__pyx_v_self->lcd));
  __pyx_v_self->lcd = ((struct __pyx_obj_5pyboy_3lcd_LCD *)Py_None);
...
/* "pyboy/window/window_headless.py":18
 *         self.lcd = None
 * 
 *     def init(self):             # <<<<<<<<<<<<<<
 *         self.blank_screen()
...
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_init(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("init", 0);

  /* "pyboy/window/window_headless.py":19
 * 
 *     def init(self):
 *         self.blank_screen()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ((struct __pyx_vtabstruct_5pyboy_6window_15window_headless_HeadlessWindow *)__pyx_v_self->__pyx_base.__pyx_base.__pyx_vtab)->__pyx_base.__pyx_base.blank_screen(((struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *)__pyx_v_self));
...
/* "pyboy/window/window_headless.py":21
 *         self.blank_screen()
 * 
 *     def set_title(self, title):             # <<<<<<<<<<<<<<
...
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_set_title(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, PyObject *__pyx_v_title) {
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  ...
  /* "pyboy/window/window_headless.py":22
 * 
 *     def set_title(self, title):
 *         if self.enable_title:             # <<<<<<<<<<<<<<
 *             logger.info("HeadlessWindow set title: %s" % title)
 * 
 */
  __pyx_t_1 = (__pyx_v_self->__pyx_base.__pyx_base.enable_title != 0);
  if (__pyx_t_1) {

    /* "pyboy/window/window_headless.py":23
 *     def set_title(self, title):
 *         if self.enable_title:
 *             logger.info("HeadlessWindow set title: %s" % title)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_info); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyString_Format(__pyx_kp_s_HeadlessWindow_set_title_s, __pyx_v_title); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_WriteUnraisable("pyboy.window.window_headless.HeadlessWindow.set_title", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "pyboy/window/window_headless.py":25
 *             logger.info("HeadlessWindow set title: %s" % title)
 * 
 *     def get_events(self):             # <<<<<<<<<<<<<<
 *         return []
...
static PyObject *__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_get_events(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("get_events", 0);

  /* "pyboy/window/window_headless.py":26
 * 
 *     def get_events(self):
 *         return []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pyboy.window.window_headless.HeadlessWindow.get_events", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "pyboy/window/window_headless.py":28
 *         return []
 * 
 *     def update_display(self):             # <<<<<<<<<<<<<<
 *         pass
...
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_update_display(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
...
/* "pyboy/window/window_headless.py":31
 *         pass
 * 
...
static PyObject *__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_getscreenbuffer(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("getscreenbuffer", 0);

  /* "pyboy/window/window_headless.py":32
 * 
 *     def getscreenbuffer(self):
 *         return self._screenbuffer_raw             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(((PyObject *)__pyx_v_self->__pyx_base._screenbuffer_raw));
  __pyx_r = ((PyObject *)__pyx_v_self->__pyx_base._screenbuffer_raw);
  goto __pyx_L0;
...
/* "pyboy/window/window_headless.py":34
 *         return self._screenbuffer_raw
 * 
 *     def frame_limiter(self, speed):             # <<<<<<<<<<<<<<
 *         pass
...
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_frame_limiter(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, CYTHON_UNUSED int __pyx_v_speed) {
  __Pyx_RefNannyDeclarations
...
/* "pyboy/window/window_headless.py":37
 *         pass
 * 
 *     def stop(self):             # <<<<<<<<<<<<<<
 *         pass
...
static void __pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_stop(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
 ...
 *     raise TypeError("self._sdlrenderer,self._sdltexturebuffer,self._window cannot be converted to a Python object for pickling")
 * def __setstate_cython__(self, __pyx_state):
 */

/* Python wrapper */
static PyObject *__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyMethodDef __pyx_mdef_5pyboy_6window_15window_headless_14HeadlessWindow_3__reduce_cython__ = {"__reduce_cython__", (PyCFunction)__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_3__reduce_cython__, METH_NOARGS, 0};
static PyObject *__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow_2__reduce_cython__(((struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *)__pyx_v_self));
...
static PyObject *__pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow_2__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pyboy.window.window_headless.HeadlessWindow.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyMethodDef __pyx_mdef_5pyboy_6window_15window_headless_14HeadlessWindow_5__setstate_cython__ = {"__setstate_cython__", (PyCFunction)__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_5__setstate_cython__, METH_O, 0};
static PyObject *__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow_4__setstate_cython__(((struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_5pyboy_6window_15window_headless_14HeadlessWindow_4__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pyboy.window.window_headless.HeadlessWindow.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* "pyboy/window/debug_window.pxd":51
...
static CYTHON_INLINE void __pyx_f_5pyboy_6window_12debug_window_6Window__update_display(struct __pyx_obj_5pyboy_6window_12debug_window_Window *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_update_display", 0);

  /* "pyboy/window/debug_window.pxd":53
 *     cdef inline void _update_display(self):
 *         # sdl2.SDL_UpdateTexture(self.sdl_texture_buffer, NULL, self.buf_p, 160*4)
 *         sdl2.SDL_UpdateTexture(self.sdl_texture_buffer, NULL, self.buf.data.as_voidptr, self.width*4)             # <<<<<<<<<<<<<<
 ...
 */
  (void)(SDL_UpdateTexture(__pyx_v_self->sdl_texture_buffer, NULL, __pyx_v_self->buf->data.as_voidptr, (__pyx_v_self->width * 4)));

  /* "pyboy/window/debug_window.pxd":54
 *         # sdl2.SDL_UpdateTexture(self.sdl_texture_buffer, NULL, self.buf_p, 160*4)
 *         sdl2.SDL_UpdateTexture(self.sdl_texture_buffer, NULL, self.buf.data.as_voidptr, self.width*4)
 *         sdl2.SDL_RenderCopy(self.sdlrenderer, self.sdl_texture_buffer, NULL, NULL)             # <<<<<<<<<<<<<<
 *         sdl2.SDL_RenderPresent(self.sdlrenderer)
 * 
 */
  (void)(SDL_RenderCopy(__pyx_v_self->sdlrenderer, __pyx_v_self->sdl_texture_buffer, NULL, NULL));

  /* "pyboy/window/debug_window.pxd":55
 *         sdl2.SDL_UpdateTexture(self.sdl_texture_buffer, NULL, self.buf.data.as_voidptr, self.width*4)
 *         sdl2.SDL_RenderCopy(self.sdlrenderer, self.sdl_texture_buffer, NULL, NULL)
 *         sdl2.SDL_RenderPresent(self.sdlrenderer)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  SDL_RenderPresent(__pyx_v_self->sdlrenderer);
...
static CYTHON_INLINE void __pyx_f_5pyboy_6window_11window_sdl2_9SDLWindow__update_display(struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_update_display", 0);
 ...
 */
  (void)(SDL_UpdateTexture(__pyx_v_self->_sdltexturebuffer, NULL, __pyx_v_self->_screenbuffer_raw->data.as_voidptr, 0x280));
 ...
 *         sdl2.SDL_RenderPresent(self._sdlrenderer)
 */
  (void)(SDL_RenderCopy(__pyx_v_self->_sdlrenderer, __pyx_v_self->_sdltexturebuffer, NULL, NULL));
...
static struct __pyx_vtabstruct_5pyboy_6window_15window_headless_HeadlessWindow __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow;

static PyObject *__pyx_tp_new_5pyboy_6window_15window_headless_HeadlessWindow(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *p;
  PyObject *o = __pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow->tp_new(t, a, k);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *)o);
  p->__pyx_base.__pyx_base.__pyx_vtab = (struct __pyx_vtabstruct_5pyboy_6window_11base_window_BaseWindow*)__pyx_vtabptr_5pyboy_6window_15window_headless_HeadlessWindow;
  p->lcd = ((struct __pyx_obj_5pyboy_3lcd_LCD *)Py_None); Py_INCREF(Py_None);
  return o;
}

static void __pyx_tp_dealloc_5pyboy_6window_15window_headless_HeadlessWindow(PyObject *o) {
  struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *p = (struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *)o;
  ...
  Py_CLEAR(p->lcd);
  PyObject_GC_Track(o);
  if (likely(__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow)) __pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow->tp_dealloc(o); else __Pyx_call_next_tp_dealloc(o, __pyx_tp_dealloc_5pyboy_6window_15window_headless_HeadlessWindow);
}

static int __pyx_tp_traverse_5pyboy_6window_15window_headless_HeadlessWindow(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *p = (struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *)o;
  e = ((likely(__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow)) ? ((__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow->tp_traverse) ? __pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow->tp_traverse(o, v, a) : 0) : __Pyx_call_next_tp_traverse(o, v, a, __pyx_tp_traverse_5pyboy_6window_15window_headless_HeadlessWindow)); if (e) return e;
  if (p->lcd) {
...
static int __pyx_tp_clear_5pyboy_6window_15window_headless_HeadlessWindow(PyObject *o) {
  PyObject* tmp;
  struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *p = (struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow *)o;
  if (likely(__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow)) { if (__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow->tp_clear) __pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow->tp_clear(o); } else __Pyx_call_next_tp_clear(o, __pyx_tp_clear_5pyboy_6window_15window_headless_HeadlessWindow);
  tmp = ((PyObject*)p->lcd);
  p->lcd = ((struct __pyx_obj_5pyboy_3lcd_LCD *)Py_None); Py_INCREF(Py_None);
  Py_XDECREF(tmp);
  return 0;
...
static PyMethodDef __pyx_methods_5pyboy_6window_15window_headless_HeadlessWindow[] = {
  {"__reduce_cython__", (PyCFunction)__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_3__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_5__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_5pyboy_6window_15window_headless_HeadlessWindow = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyboy.window.window_headless.HeadlessWindow", /*tp_name*/
  sizeof(struct __pyx_obj_5pyboy_6window_15window_headless_HeadlessWindow), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_5pyboy_6window_15window_headless_HeadlessWindow, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_5pyboy_6window_15window_headless_HeadlessWindow, /*tp_traverse*/
  __pyx_tp_clear_5pyboy_6window_15window_headless_HeadlessWindow, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_5pyboy_6window_15window_headless_HeadlessWindow, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pw_5pyboy_6window_15window_headless_14HeadlessWindow_1__init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_5pyboy_6window_15window_headless_HeadlessWindow, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyboy.window.window_headless.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyboy.window.window_headless.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyboy.window.window_headless.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyboy.window.window_headless._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_HeadlessWindow, __pyx_k_HeadlessWindow, sizeof(__pyx_k_HeadlessWindow), 0, 0, 1, 1},
  {&__pyx_n_s_HeadlessWindow___reduce_cython, __pyx_k_HeadlessWindow___reduce_cython, sizeof(__pyx_k_HeadlessWindow___reduce_cython), 0, 0, 1, 1},
  {&__pyx_n_s_HeadlessWindow___setstate_cython, __pyx_k_HeadlessWindow___setstate_cython, sizeof(__pyx_k_HeadlessWindow___setstate_cython), 0, 0, 1, 1},
  {&__pyx_kp_s_HeadlessWindow_set_title_s, __pyx_k_HeadlessWindow_set_title_s, sizeof(__pyx_k_HeadlessWindow_set_title_s), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_SDLWindow, __pyx_k_SDLWindow, sizeof(__pyx_k_SDLWindow), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pyboy_window_window_headless, __pyx_k_pyboy_window_window_headless, sizeof(__pyx_k_pyboy_window_window_headless), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_self__sdlrenderer_self__sdltextu, __pyx_k_self__sdlrenderer_self__sdltextu, sizeof(__pyx_k_self__sdlrenderer_self__sdltextu), 0, 0, 1, 0},
 ...
 *     raise TypeError("self._sdlrenderer,self._sdltexturebuffer,self._window cannot be converted to a Python object for pickling")
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_self__sdlrenderer_self__sdltextu); if (unlikely(!__pyx_tuple_)) __PYX_ERR(1, 2, __pyx_L1_error)
 ...
 *     raise TypeError("self._sdlrenderer,self._sdltexturebuffer,self._window cannot be converted to a Python object for pickling")             # <<<<<<<<<<<<<<
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_self__sdlrenderer_self__sdltextu); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(1, 4, __pyx_L1_error)
...
static int __Pyx_modinit_variable_export_code(void) {
  ...
  if (__Pyx_ExportVoidPtr(__pyx_n_s_dummy_declaration, (void *)&__pyx_v_5pyboy_6window_15window_headless__dummy_declaration, "__pyx_ctuple_int__and_int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportVoidPtr(__pyx_n_s_dummy_declaration2, (void *)&__pyx_v_5pyboy_6window_15window_headless__dummy_declaration2, "__pyx_ctuple_int__and_int__and_int__and_int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportVoidPtr(__pyx_n_s_ROWS, (void *)&__pyx_v_5pyboy_6window_15window_headless_ROWS, "int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportVoidPtr(__pyx_n_s_COLS, (void *)&__pyx_v_5pyboy_6window_15window_headless_COLS, "int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  __pyx_t_1 = PyImport_ImportModule("pyboy.window.window_sdl2"); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow = __Pyx_ImportType(__pyx_t_1, "pyboy.window.window_sdl2", "SDLWindow", sizeof(struct __pyx_obj_5pyboy_6window_11window_sdl2_SDLWindow), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_vtabptr_5pyboy_6window_11window_sdl2_SDLWindow = (struct __pyx_vtabstruct_5pyboy_6window_11window_sdl2_SDLWindow*)__Pyx_GetVtable(__pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow->tp_dict); if (unlikely(!__pyx_vtabptr_5pyboy_6window_11window_sdl2_SDLWindow)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_vtabptr_5pyboy_6window_15window_headless_HeadlessWindow = &__pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base = *__pyx_vtabptr_5pyboy_6window_11window_sdl2_SDLWindow;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base.__pyx_base.init = (void (*)(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *))__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_init;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base.__pyx_base.set_title = (void (*)(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *, PyObject *))__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_set_title;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base.__pyx_base.get_events = (PyObject *(*)(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *))__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_get_events;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base.__pyx_base.update_display = (void (*)(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *))__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_update_display;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base.__pyx_base.frame_limiter = (void (*)(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *, int))__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_frame_limiter;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base.__pyx_base.stop = (void (*)(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *))__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_stop;
  __pyx_vtable_5pyboy_6window_15window_headless_HeadlessWindow.__pyx_base.__pyx_base.getscreenbuffer = (PyObject *(*)(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow *))__pyx_f_5pyboy_6window_15window_headless_14HeadlessWindow_getscreenbuffer;
  __pyx_type_5pyboy_6window_15window_headless_HeadlessWindow.tp_base = __pyx_ptype_5pyboy_6window_11window_sdl2_SDLWindow;
  if (PyType_Ready(&__pyx_type_5pyboy_6window_15window_headless_HeadlessWindow) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_type_5pyboy_6window_15window_headless_HeadlessWindow.tp_print = 0;
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_5pyboy_6window_15window_headless_HeadlessWindow.tp_dictoffset && __pyx_type_5pyboy_6window_15window_headless_HeadlessWindow.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_5pyboy_6window_15window_headless_HeadlessWindow.tp_getattro = __Pyx_PyObject_GenericGetAttr;
  }
  if (__Pyx_SetVtable(__pyx_type_5pyboy_6window_15window_headless_HeadlessWindow.tp_dict, __pyx_vtabptr_5pyboy_6window_15window_headless_HeadlessWindow) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_HeadlessWindow, (PyObject *)&__pyx_type_5pyboy_6window_15window_headless_HeadlessWindow) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_5pyboy_6window_15window_headless_HeadlessWindow) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_ptype_5pyboy_6window_15window_headless_HeadlessWindow = &__pyx_type_5pyboy_6window_15window_headless_HeadlessWindow;
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("pyboy.window.base_window"); if (unlikely(!__pyx_t_1)) __PYX_ERR(5, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5pyboy_6window_11base_window_BaseWindow = __Pyx_ImportType(__pyx_t_1, "pyboy.window.base_window", "BaseWindow", sizeof(struct __pyx_obj_5pyboy_6window_11base_window_BaseWindow), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5pyboy_6window_11base_window_BaseWindow) __PYX_ERR(5, 18, __pyx_L1_error)
  __pyx_vtabptr_5pyboy_6window_11base_window_BaseWindow = (struct __pyx_vtabstruct_5pyboy_6window_11base_window_BaseWindow*)__Pyx_GetVtable(__pyx_ptype_5pyboy_6window_11base_window_BaseWindow->tp_dict); if (unlikely(!__pyx_vtabptr_5pyboy_6window_11base_window_BaseWindow)) __PYX_ERR(5, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("pyboy.window.debug_window"); if (unlikely(!__pyx_t_1)) __PYX_ERR(6, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5pyboy_6window_12debug_window_Window = __Pyx_ImportType(__pyx_t_1, "pyboy.window.debug_window", "Window", sizeof(struct __pyx_obj_5pyboy_6window_12debug_window_Window), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5pyboy_6window_12debug_window_Window) __PYX_ERR(6, 26, __pyx_L1_error)
  __pyx_vtabptr_5pyboy_6window_12debug_window_Window = (struct __pyx_vtabstruct_5pyboy_6window_12debug_window_Window*)__Pyx_GetVtable(__pyx_ptype_5pyboy_6window_12debug_window_Window->tp_dict); if (unlikely(!__pyx_vtabptr_5pyboy_6window_12debug_window_Window)) __PYX_ERR(6, 26, __pyx_L1_error)
  __pyx_ptype_5pyboy_6window_12debug_window_TileWindow = __Pyx_ImportType(__pyx_t_1, "pyboy.window.debug_window", "TileWindow", sizeof(struct __pyx_obj_5pyboy_6window_12debug_window_TileWindow), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5pyboy_6window_12debug_window_TileWindow) __PYX_ERR(6, 63, __pyx_L1_error)
  __pyx_vtabptr_5pyboy_6window_12debug_window_TileWindow = (struct __pyx_vtabstruct_5pyboy_6window_12debug_window_TileWindow*)__Pyx_GetVtable(__pyx_ptype_5pyboy_6window_12debug_window_TileWindow->tp_dict); if (unlikely(!__pyx_vtabptr_5pyboy_6window_12debug_window_TileWindow)) __PYX_ERR(6, 63, __pyx_L1_error)
  __pyx_ptype_5pyboy_6window_12debug_window_TileViewWindow = __Pyx_ImportType(__pyx_t_1, "pyboy.window.debug_window", "TileViewWindow", sizeof(struct __pyx_obj_5pyboy_6window_12debug_window_TileViewWindow), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5pyboy_6window_12debug_window_TileViewWindow) __PYX_ERR(6, 70, __pyx_L1_error)
  __pyx_vtabptr_5pyboy_6window_12debug_window_TileViewWindow = (struct __pyx_vtabstruct_5pyboy_6window_12debug_window_TileViewWindow*)__Pyx_GetVtable(__pyx_ptype_5pyboy_6window_12debug_window_TileViewWindow->tp_dict); if (unlikely(!__pyx_vtabptr_5pyboy_6window_12debug_window_TileViewWindow)) __PYX_ERR(6, 70, __pyx_L1_error)
  __pyx_ptype_5pyboy_6window_12debug_window_DebugWindow = __Pyx_ImportType(__pyx_t_1, "pyboy.window.debug_window", "DebugWindow", sizeof(struct __pyx_obj_5pyboy_6window_12debug_window_DebugWindow), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5pyboy_6window_12debug_window_DebugWindow) __PYX_ERR(6, 77, __pyx_L1_error)
  __pyx_vtabptr_5pyboy_6window_12debug_window_DebugWindow = (struct __pyx_vtabstruct_5pyboy_6window_12debug_window_DebugWindow*)__Pyx_GetVtable(__pyx_ptype_5pyboy_6window_12debug_window_DebugWindow->tp_dict); if (unlikely(!__pyx_vtabptr_5pyboy_6window_12debug_window_DebugWindow)) __PYX_ERR(6, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
static int __Pyx_modinit_variable_import_code(void) {
  ...
  __pyx_t_3 = PyImport_ImportModule("pyboy.window.debug_window"); if (!__pyx_t_3) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_3, "_dummy_declaration2", (void **)&__pyx_vp_5pyboy_6window_12debug_window__dummy_declaration2, "__pyx_ctuple_int__and_int__and_int__and_int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_3, "TILES", (void **)&__pyx_vp_5pyboy_6window_12debug_window_TILES, "int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_3, "COLOR", (void **)&__pyx_vp_5pyboy_6window_12debug_window_COLOR, "int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_3, "MASK", (void **)&__pyx_vp_5pyboy_6window_12debug_window_MASK, "int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_3, "GAMEBOY_RESOLUTION", (void **)&__pyx_vp_5pyboy_6window_12debug_window_GAMEBOY_RESOLUTION, "__pyx_ctuple_int__and_int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  Py_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = PyImport_ImportModule("pyboy.window.window_sdl2"); if (!__pyx_t_4) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_4, "_dummy_declaration", (void **)&__pyx_vp_5pyboy_6window_11window_sdl2__dummy_declaration, "__pyx_ctuple_int__and_int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_4, "_dummy_declaration2", (void **)&__pyx_vp_5pyboy_6window_11window_sdl2__dummy_declaration2, "__pyx_ctuple_int__and_int__and_int__and_int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_4, "ROWS", (void **)&__pyx_vp_5pyboy_6window_11window_sdl2_ROWS, "int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_4, "COLS", (void **)&__pyx_vp_5pyboy_6window_11window_sdl2_COLS, "int") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pyboy__window__window_headless) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyboy.window.window_headless")) {
      if (unlikely(PyDict_SetItemString(modules, "pyboy.window.window_headless", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyboy/window/window_headless.py":6
 * #
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_s_SDLWindow);
  __Pyx_GIVEREF(__pyx_n_s_SDLWindow);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_SDLWindow);
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_window_sdl2, __pyx_t_1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pyboy/window/window_headless.py":7
 * 
 * from .window_sdl2 import SDLWindow
 * from ..logger import logger             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_logger, __pyx_t_2, 2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "pyboy/window/window_headless.py":10
 * 
 * 
 * ROWS, COLS = 144, 160             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_3 = 0x90;
  __pyx_t_4 = 0xA0;
  __pyx_v_5pyboy_6window_15window_headless_ROWS = __pyx_t_3;
  __pyx_v_5pyboy_6window_15window_headless_COLS = __pyx_t_4;
 ...
 * def __setstate_cython__(self, __pyx_state):
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_5pyboy_6window_15window_headless_14HeadlessWindow_3__reduce_cython__, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_HeadlessWindow___reduce_cython, NULL, __pyx_n_s_pyboy_window_window_headless, __pyx_d, ((PyObject *)__pyx_codeobj__22)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     raise TypeError("self._sdlrenderer,self._sdltexturebuffer,self._window cannot be converted to a Python object for pickling")
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_5pyboy_6window_15window_headless_14HeadlessWindow_5__setstate_cython__, __Pyx_CYFUNCTION_CCLASS, __pyx_n_s_HeadlessWindow___setstate_cython, NULL, __pyx_n_s_pyboy_window_window_headless, __pyx_d, ((PyObject *)__pyx_codeobj__24)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_setstate_cython, __pyx_t_1) < 0) __PYX_ERR(1, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pyboy/window/window_headless.py":1
 * #             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyboy.window.window_headless", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyboy.window.window_headless");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
