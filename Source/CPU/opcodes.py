...
opcode_3x = [(2, (12, 8), lambda s, v, e: (not s.testFlag(flagC) and (s.setPC(e+getSignedInt8(v)) or True)) or s.setPC(e)),      # 30 - "Relative jump by signed immediate if last result caused no carry" ("JR NC,r8")
             ...
             (1, (12,), lambda s, e: s.ram.__setitem__(s.getHL(), s.ram[s.getHL()]+1) or s.setPC(e)),  # 34 - "Increment value pointed by HL" ("INC (HL)
             (1, (12,), lambda s, e: s.ram.__setitem__(s.getHL(), s.ram[s.getHL()]-1) or s.setPC(e)),  # 35 - "Decrement value pointed by HL" ("DEC (HL)
