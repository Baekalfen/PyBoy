...
def addPopToStack(s):
    try:
        ...
        self.logger("Tried to pop from empty call stack")
...
if __name__ == "__main__":
    logger("opcodes", len(opcodes))
    logger("opcode_0x", len(opcode_0x))
    logger("opcode_1x", len(opcode_1x))
    logger("opcode_2x", len(opcode_2x))
    logger("opcode_3x", len(opcode_3x))
    logger("opcode_4x", len(opcode_4x))
    logger("opcode_5x", len(opcode_5x))
    logger("opcode_6x", len(opcode_6x))
    logger("opcode_7x", len(opcode_7x))
    logger("opcode_8x", len(opcode_8x))
    logger("opcode_9x", len(opcode_9x))
    logger("opcode_Ax", len(opcode_Ax))
    logger("opcode_Bx", len(opcode_Bx))
    logger("opcode_Cx", len(opcode_Cx))
    logger("opcode_Dx", len(opcode_Dx))
    logger("opcode_Ex", len(opcode_Ex))
    logger("opcode_Fx", len(opcode_Fx))
    logger("CB_prefix_0x", len(CB_prefix_0x))
    logger("CB_prefix_1x", len(CB_prefix_1x))
    logger("CB_prefix_2x", len(CB_prefix_2x))
    logger("CB_prefix_3x", len(CB_prefix_3x))
    logger("CB_prefix_4x", len(CB_prefix_4x))
    logger("CB_prefix_5x", len(CB_prefix_5x))
    logger("CB_prefix_6x", len(CB_prefix_6x))
    logger("CB_prefix_7x", len(CB_prefix_7x))
    logger("CB_prefix_8x", len(CB_prefix_8x))
    logger("CB_prefix_9x", len(CB_prefix_9x))
    logger("CB_prefix_Ax", len(CB_prefix_Ax))
    logger("CB_prefix_Bx", len(CB_prefix_Bx))
    logger("CB_prefix_Cx", len(CB_prefix_Cx))
    logger("CB_prefix_Dx", len(CB_prefix_Dx))
    logger("CB_prefix_Ex", len(CB_prefix_Ex))
    logger("CB_prefix_Fx", len(CB_prefix_Fx))
