...
def checkForInterrupts(self):
    ...
    if anyInterruptToHandle and self.interruptMasterEnable:
        ...
        if self.testInterruptFlagEnabled(VBlank) and self.testInterruptFlag(VBlank): # Vertical Blank
            # logging.info("Vertical Blank Interrupt")
            # logging.info("Interrupt enable", bin(self.mb[0xFFFF]))
            ...
            # logging.info("LCDC Status Interrupt")
            ...
            # logging.info("TIMER Overflow Interrupt")
            ...
            logging.info("Serial Transfer Interrupt")
